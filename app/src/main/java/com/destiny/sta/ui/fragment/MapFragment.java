...
public class MapFragment extends Fragment implements OnMapReadyCallback {
    ...
    private void startLocationUpdates() {
        if (googleMap == null || isLocationUpdated) return;
        ...
        fusedLocationClient.requestLocationUpdates(locationRequest, googleLocationCallback, null /* Looper */);
    ...
    com.google.android.gms.location.LocationCallback googleLocationCallback = new com.google.android.gms.location.LocationCallback() {
        @Override
        public void onLocationResult(LocationResult locationResult) {
            for (Location location : locationResult.getLocations()) {
                ...
                if (location != null) {
                    ...
                    googleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(currentLatLng, 17.0f)); //16.0f
...
//                    try {
//                        Date openingTime = formatter.parse(user.getBranch().getOpeningTime());
//                        Date closingTime = formatter.parse(user.getBranch().getClosingTime());
//                        Date loginTime = formatter.parse(user.getTime());
//                        Log.v(TAG, "opening_time: " + openingTime.toString() + " closing_time: " + closingTime.toString() + " login_time: " + loginTime.toString());
//                        if(loginTime.after(openingTime) && loginTime.before(closingTime) || (loginTime.equals(openingTime) || loginTime.equals(closingTime))) {
//                            inTime = true;
//                        }
